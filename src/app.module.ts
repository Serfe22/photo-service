...
import { JwtStrategy } from './auth/jwt.strategy';  // Correct path to jwt.strategy // didnt implement
import { ProfileModule } from './profile/profile.module';
// import { AuthModule } from './auth/auth.module';  // didnt implement
...
@Module({
  imports: [
    TypeOrmModule.forRoot({
      ...
      entities: [User, Photo, Category, Profile, PhotoCategory],  
      synchronize: true,  
    }),
    UserModule,
    PhotoModule,
